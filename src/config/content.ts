...
export const posts = [
  { slug: "engineering-for-longevity", title: "Engineering for longevity: why proven technology wins", date: "12 October 2026", authoredDate: "2026-10-12", category: "Engineering", excerpt: "Reliable systems are built by spending innovation on the business problem, not repeatedly replacing the foundation.", lead: "In an industry obsessed with the new, the most maintainable systems are often built using proven, stable technologies." },
  { slug: "designing-with-typography", title: "The hierarchy of information", date: "28 September 2026", authoredDate: "2026-09-28", category: "Design", excerpt: "How typographic scale and rhythm can clarify dense enterprise workflows.", lead: "Typography is not a finishing layer. In complex products, it is the primary interface for understanding priority and relationship." },
  { slug: "technical-due-diligence", title: "Beyond the codebase", date: "15 September 2026", authoredDate: "2026-09-15", category: "Strategy", excerpt: "What a serious technical review reveals about an organisation’s capacity to change.", lead: "A codebase is evidence, but never the whole story. Delivery habits, ownership, and operating constraints determine whether architecture can support the plan." }
] as const;
